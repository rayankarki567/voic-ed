...
export default function VotingPage() {
  ...
  const activeElections = [
    ...
    },
    {
      ...
      options: [
        ...
        {
          id: 2,
          title: "Upgrade Athletic Facilities",
          votes: 185,
  ...
  const pastElections = [
    {
      id: 3,
      title: "Library Hours Extension Vote",
      description: "Vote on extending library hours during exam periods.",
      startDate: "April 10, 2025",
      endDate: "April 15, 2025",
      result: "Approved",
      turnout: "68% of eligible voters",
      options: [
        { id: 1, title: "Extend to 24/7 during exams", votes: 320, percentage: 65 },
        { id: 2, title: "Extend to midnight only", votes: 120, percentage: 24 },
        { id: 3, title: "Keep current hours", votes: 55, percentage: 11 },
      ],
    },
    {
      id: 4,
      ...
      positions: [
        {
          ...
          candidates: [
            { id: 6, name: "James Wilson", avatar: "JW", votes: 187, percentage: 52, elected: true },
            { id: 7, name: "Sophia Lee", avatar: "SL", votes: 108, percentage: 30 },
            { id: 8, name: "Omar Hassan", avatar: "OH", votes: 65, percentage: 18 },
          ],
        },
      ],
    },
